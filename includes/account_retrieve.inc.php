<?php
$update_account_info = "SELECT first_name, last_name, email, phone, address_1, address_2, city, mousepad_states_id, zip, date(date_created) as date_created
	FROM mousepad_customers WHERE mousepad_customers_id = $mousepad_customers_id";
