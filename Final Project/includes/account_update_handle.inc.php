...
if(count($errors_array)==0){
	...
	$update_mousepad_customers = "UPDATE mousepad_customers 
		SET 
		...
		address_2 = '$address_2',
		city = '$city',
		mousepad_states_id = '$mousepad_states_id',
		zip = '$zip',
		date_created = '$date_created'
		WHERE mousepad_customers_id = $mousepad_customers_id";
	$exec_update_mousepad_customers = @mysqli_query($link, $update_mousepad_customers);
