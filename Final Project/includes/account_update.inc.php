<form action='<? echo $_SERVER['PHP_SELF']; ?>' method='POST' name='account_update_form' id='account_update_form' enctype='multipart/form-data'>
	<fieldset><legend>Registration</legend>
		<?php
			...
			if(!$exec_select_states){
				...
				create_drop_down_from_query('State: ', 'mousepad_states_id', 'mousepad_states_id', $multi_array, ['tabindex'=>'9', 'title'=>'State'], $errors_array);
			}
	...
	<p>
		<label>
			<input type='hidden' value='<?php echo $mousepad_customers_id; ?>' name='mousepad_customers_id' id='form_submitted' />
